...
public class DualCoveringTest
{
	...
	private Set<DualCovering.Rect> _rectangulos;
	...
	public void tresRectangulosSinInterseccionComunTest()
	{
		...
		System.out.println("************");
		for(DualCovering.Rect r: _rectangulos)
	...
	{
		_covering = new DualCovering(_dual, _instancia.getSemillas().get(0));
	...
	{
		for(DualCovering.Rect rect: _rectangulos)
		{
